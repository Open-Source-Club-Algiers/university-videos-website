...
function LeftVideoSection({
  ...
  return (
    ...
    >
      ...
      <div className="relative md:ml-[190px] p-3 w-full md:w-[95%] lg:w-[83%] xl:w-[860px] lg:h-[550px] h-[760px] flex flex-col lg:flex-row justify-center items-center">
        <div
          className="absolute inset-0 bg-cover bg-center filter blur-[2px] z-0"
          style={{
            backgroundImage: `url(${imgLink})`,
          }}
        ></div>
        <div className="relative z-10 xl:translate-x-[-18%] lg:translate-x-[-23%] lg:max-h-[370px] h-[285px] translate-y-[-20px] lg:w-[620px] xl:w-[700px] rounded-[20px] flex justify-center items-center">
          <video
            width="100%"
            height="100%"
        ...
        <div className="mr-4 relative lg:translate-y-[50px] lg:float-right flex justify-center items-center flex-col">
          <div className="flex flex-col items-start justify-between w-[100%] xl:ml-[0%] ml-[20%]">
            {licenceSpecialite && (
              <p
                className={`lg:text-[21px] font-bold xl:text-[20px] ${
